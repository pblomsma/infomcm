...
#2017 values, based on question 3.
singleTaskKeyPressTimes <- c(250,250,250,250,250,250,250,250,250,250,250)   #digit times needed per keypress at that specific position (note: normalized for chunk retrieval time at digits 1 and 6 --- a retrieval cost would come on top of this)
